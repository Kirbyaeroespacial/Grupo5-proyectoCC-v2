...
void loop() {
  ...
  //!G 5. Validación de checksum en comandos recibidos
  ...
  //!G 6. Recuperación automática por timeout
  ...
  if (now - lastSend >= sendPeriod) {
    //!G 7. Verificación de turno antes de transmitir
    if (sending && canTransmit) {
      ...
      //!G 8. Envío de posición orbital
      simulate_orbit();

      //!G 9. Liberación de turno
      sendPacketWithChecksum(67, "0");
      canTransmit = false;
    }

    //!G 10. Eliminado heartbeat "g"
