...
# Setup del serial
device = 'COM13'  # CAMBIAR según tu puerto
usbSerial = None
...
# Ground track data (lat/lon convertidas)
ground_track_lat = []
ground_track_lon = []
...
def xyz_to_latlon(x, y, z):
    """
    Convierte coordenadas cartesianas (x, y, z) a latitud/longitud.
    Asume sistema de coordenadas donde:
    - x apunta al meridiano 0° (Greenwich)
    - y apunta a 90°E
    - z apunta al polo norte
    """
...
# === CONTENEDOR DE GRÁFICOS (3 columnas en una fila) ===
...
Label(orbit_frame, text="🌍 Órbita Satelital (3D)", font=subtitle_font, 
...
# Botón Ground Track
btn_ground_track = Button(events_frame, text="🗺️ Ver Ground Track", 
                         font=button_font, bg="royalblue", fg="white", 
                         relief=FLAT, bd=0, padx=20, pady=8, width=20)
...
def abrir_ground_track():
    ...
    try:
        ...
        print("⚠️ No se encontró world_map.png - usando fondo sin mapa")
        print("   Coloca una imagen 'world_map.png' en la carpeta del script")
    except Exception as e:
