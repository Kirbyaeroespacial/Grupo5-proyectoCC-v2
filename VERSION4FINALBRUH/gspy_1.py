...
panel_indicator_frame = Frame(title_frame, bg="#1e1e2f")
panel_indicator_frame.pack(side=LEFT, padx=15)

Label(panel_indicator_frame, text="☀️ Panel Solar:", font=("Inter", 11, "bold"), 
      bg="#1e1e2f", fg="white").pack(side=LEFT, padx=5)

panel_label = Label(panel_indicator_frame, text="0%", font=("Inter", 11, "bold"),
                   bg="#ff6b6b", fg="white", padx=10, pady=3, relief=RIDGE, bd=2)
panel_label.pack(side=LEFT)

def update_panel_indicator():
    """Actualiza el indicador visual del panel solar"""
    with panel_lock:
        state = panel_state
