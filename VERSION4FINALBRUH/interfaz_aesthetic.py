...
Label(interval_frame, text="⏱️ Intervalo (ms):", 
      font=("Arial", 10), bg="navy", fg="white").pack()

entry_tiempo = Entry(interval_frame, font=("Arial", 12), width=15)
entry_tiempo.pack(pady=5, ipady=3)
...
btn_validar = Button(interval_frame, text="✓ Validar", 
                     ...
                     relief=FLAT, bd=0, padx=15, pady=8, command=leer_vel)
